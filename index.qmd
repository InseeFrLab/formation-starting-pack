...
::: {.callout-warning collapse="false"}
__The function `install.packages()` must not be used anywhere in the documents__ because it is not the proper way to manage package requirements (see below for recommendations on dependency management).
:::
