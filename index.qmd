...
## Step 2: develop resources with `Quarto` on the SSPCloud
...
- Go the "My Services" Tab;
- __On the first time you develop resources on this particular project:__
...
## Step 3: develop resources with `Quarto` on the SSPCloud
