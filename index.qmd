...
To make this possible, a few technical prerequisites are needed - these are outlined in @importantreq.
...
::: {#important-req .callout-important collapse="false"}
...
## Step 2: get started with `Quarto`  {{< iconify simple-icons:quarto style="color:#74aadb;" >}} on the SSPCloud
