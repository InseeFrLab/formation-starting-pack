...
- Navigate to the Git panel, click on "Clone" to clone the repository you created in step 1 (for instance: `https://www.github.com/AIML4OS/Intro_To_Linear_Regression`).
- Develop your resources. Do not forget to commit and push regularly.
