...
- Define all aspects of the training environment using the usual interface. Here are the elements you will probably want to configure:
  ...
  - `Resources`: choose the requests and limits that are well-suited for your use case. Some trial-and-error might be necessary here. 
  - `Initialization scripts`: you can add here the URL to an initialization script. This script can do many things, such as installing dependencies and downloading data.
