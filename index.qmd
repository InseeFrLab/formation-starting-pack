...
From here on, we assume that training material is made available in the following form:
...
SSPCloud is useful for trainees but also for trainers. It is quite convenient to use that platform when developing educational resources: given the way it works, this will help a lot to make your educational resources reproducible.
