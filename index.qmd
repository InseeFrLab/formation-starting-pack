...
These templates contain all what you need to produce resources that can be easily made available as websites or as  training material on the SSP Cloud. More precisely, these templates contain:
...
If you have created a repository from a template and defined a development configuration, developing resources basically amounts to modifying the minimal examples available in your repositoryy.
