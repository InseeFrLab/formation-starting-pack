...
* `Python` {{< fa brands python >}}: [template](https://github.com/InseeFrLab/AIML4OS-template-quarto-python).
...
- Customize the configuration by changing four settings:
  ...
  + (optional) In the "Initialization scripts" tab, paste the URL of your init script (for instance: `https://raw.githubusercontent.com/InseeFrLab/AIML4OS-template-quarto-r/refs/heads/main/init.sh`);
