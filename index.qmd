...
#### __Managing dependencies with `R`: using `renv`__
...
For more information, see the [official documentation of `renv`](https://rstudio.github.io/renv/articles/renv.html).

#### __Managing dependencies with Python: à compléter par Lino__
